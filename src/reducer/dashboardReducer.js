...
const decreaseValue = (
  currentValue,
  decrement = 1,
  min = BUSINESS_CONSTANTS.MIN_VALUE
) => Math.max(currentValue - decrement, min);

/**
 * Dashboard reducer to manage dashboard state updates.
  ...
  switch (action.type) {
    ...
    case DASHBOARD_ACTIONS.ADD_ORDER: {
      return {
        ...
        totalRevenue: increaseValue(
          state.totalRevenue,
          BUSINESS_CONSTANTS.ORDER_VALUE
        ),
      };
    }
